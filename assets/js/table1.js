    var theUL = document.getElementById("pageListTableBody1");
    var totalPage = document.getElementById("spanTotalPage1");
    var pageNum = document.getElementById("spanPageNum1"); //获取当前页<span>
    var spanPre = document.getElementById("spanPre1"); //获取上一页<span>
    var spanNext = document.getElementById("spanNext1"); //获取下一页<span>
    var spanFirst = document.getElementById("spanFirst1"); //获取第一页<span>
    var spanLast = document.getElementById("spanLast1"); //获取最后一页<span>
